        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
	            ...
	            <p class="breadcrumbs"><span class="mr-2"><a href="index.do">Home</a></span> <span>Product Detail</span></p>
            </div>
    ...
    <section class="ftco-section">
    	<div class="container">
    		<div class="row">
          	...
          	<p><a href="cart.do" class="btn btn-primary py-3 px-5">Add to Cart</a></p>
    			</div>
    		</div>
    	</div>
    </section>
