...
<head>
<meta charset="UTF-8">
<title>recipe Edit Detail</title>
...
<div class="container">
	...
	<div class="comment-form-wrap pt-5">
		<form action="recipeEditDetailPro.eat" method="post" enctype="multipart/form-data">
		<h1>${cnum}</h1><br/>
		<h4>레시피 세부 사진을 등록해주세요 </h4>
		<h4> (조리법 갯수에 맞춰서 이미지를 올리면 깔끔하게 보입니다.)</h4>
		<h4> (*사진은 8개까지만 등록됩니다!)</h4><br/>
		<input type="hidden" name="cnum" value="${cnum}"><br/><br/>
		...
		<h4>레시피 8번 사진을 등록해주세요</h4>
			...
			<div class="form-group">
		    	<input type="submit" value="레시피 수정"  class="btn py-3 px-4 btn-primary"  />
			</div>
		</form>
	</div>
</div>
