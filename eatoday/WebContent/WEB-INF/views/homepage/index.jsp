...
<section class="ftco-counter ftco-bg-dark img" id="section-counter" style="background-color: rgba( 255, 255, 255, 0.1 );">
	<div class="overlay"></div>
	<div class="container">
									...
									<div class="find-place-img_wrap">
										<div class="grid">
											<figure class="effect-ruby">
												<a href="<c:url value="/restaurant/restaurantList.eat"><c:param name="cate" value="한식"></c:param><c:param name="area" value="서울"></c:param></c:url>">
													<img src="/eatoday/resource/images/korean.JPG" class="img-fluid" alt="img13" /></a>
												<figcaption>
													<h5 align="center" style="color:white;"><a href="<c:url value="/restaurant/restaurantList.eat"><c:param name="cate" value="한식"></c:param><c:param name="area" value="서울"></c:param></c:url>">한식</a></h5>
												</figcaption>
											</figure>
										</div>
									</div>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="find-place-img_wrap">
										<div class="grid">
											<figure class="effect-ruby">
												<a href="<c:url value="/restaurant/restaurantList.eat"><c:param name="cate" value="분식"></c:param><c:param name="area" value="서울"></c:param></c:url>">
													<img src="/eatoday/resource/images/bunsik.JPG" class="img-fluid" alt="img13" /></a>
													<figcaption>
														<h5 align="center" style="color:white;"><a href="<c:url value="/restaurant/restaurantList.eat"><c:param name="cate" value="분식"></c:param><c:param name="area" value="서울"></c:param></c:url>">분식</a></h5>
													</figcaption>
											</figure>
										</div>
									</div>
						...
						<div class="row find-img-align">
							<div class="col-md-12">
								<div class="find-place-img_wrap">
									<div class="grid">
										<figure class="effect-ruby">
											<a href="<c:url value="/restaurant/restaurantList.eat"><c:param name="cate" value="양식"></c:param><c:param name="area" value="서울"></c:param></c:url>">
												<img src="/eatoday/resource/images/west.JPG" class="img-fluid" alt="img13" /></a>
												<figcaption>
													<h5 align="center" style="color:white;"><a href="<c:url value="/restaurant/restaurantList.eat"><c:param name="cate" value="양식"></c:param><c:param name="area" value="서울"></c:param></c:url>">양식</a></h5>
												</figcaption>
										</figure>
									</div>
								</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="find-place-img_wrap">
									<div class="grid">
										<figure class="effect-ruby">
											<a href="<c:url value="/restaurant/restaurantList.eat"><c:param name="cate" value="중식"></c:param><c:param name="area" value="서울"></c:param></c:url>">
												<img src="/eatoday/resource/images/china.JPG" class="img-fluid" alt="img13" /></a>
												<figcaption>
													<h5 align="center" style="color:white;"><a href="<c:url value="/restaurant/restaurantList.eat"><c:param name="cate" value="중식"></c:param><c:param name="area" value="서울"></c:param></c:url>">중식</a></h5>
												</figcaption>
										</figure>
									</div>
								</div>
						...
						<div class="row find-img-align">
							<div class="col-md-12">
								<div class="find-place-img_wrap">
									<div class="grid">
										<figure class="effect-ruby">
											<a href="<c:url value="/restaurant/restaurantList.eat"><c:param name="cate" value="일식"></c:param><c:param name="area" value="서울"></c:param></c:url>">
												<img src="/eatoday/resource/images/japan.jpg" class="img-fluid" alt="img13" /></a>
												<figcaption>
													<h5 align="center" style="color:white;"><a href="<c:url value="/restaurant/restaurantList.eat"><c:param name="cate" value="일식"></c:param><c:param name="area" value="서울"></c:param></c:url>">일식</a></h5>
												</figcaption>
										</figure>
									</div>
								</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="find-place-img_wrap">
									<div class="grid">
										<figure class="effect-ruby">
											<a href="<c:url value="/restaurant/restaurantList.eat"><c:param name="cate" value="카페"></c:param><c:param name="area" value="서울"></c:param></c:url>">
												<img src="/eatoday/resource/images/cafe.JPG" class="img-fluid" alt="img13" /></a>
												<figcaption>
													<h5 align="center" style="color:white;"><a href="<c:url value="/restaurant/restaurantList.eat"><c:param name="cate" value="카페"></c:param><c:param name="area" value="서울"></c:param></c:url>">카페</a></h5>
												</figcaption>
										</figure>
									</div>
								</div>
...
<section class="ftco-counter ftco-bg-dark img" style="background-color: rgba( 255, 255, 255, 0.05 );">
	<div class="container">
		<div class="row">
			<div class="catMap">
