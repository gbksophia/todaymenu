...
Kakao.init('112ecff57900a2dd120c152f6c326b7b');
		...
		<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54" style = "margin-top : 100px">
			<form class="login100-form validate-form" name="frm">
				...
				<div class="text-left p-t-8 p-b-31">
					<a href="/eatoday/memberpage/idSearch.eat">아이디 찾기</a>
					&nbsp;|&nbsp;
					<a href = "/eatoday/memberpage/pwSearch.eat">비밀번호 찾기</a>
				</div>
				...
				<div class="flex-c-m">
					<!-- 네이버 로그인 -->
					<a href="${url}" class="login100-social-item bg1"><img src="/eatoday/resource/images/naver.JPG" width="55"></a>
					<!-- 카카오 로그인 -->
					<a id="custom-login-btn" href="javascript:loginWithKakao()"><img src="/eatoday/resource/images/kakao.jpg" width="55"/></a>
					<!-- 구글 로그인 -->
					<a href="javascript:void(0);" onclick="loginWithGoogle();"class="login100-social-item bg3"><i class="fa fa-google"></i></a>
				</div>

				<div class="txt1 text-center p-t-54 p-b-20">
					<a href="sign.eat" class="txt2">Sign Up</a>
				</div>
			</form>
		</div>
	</div>
