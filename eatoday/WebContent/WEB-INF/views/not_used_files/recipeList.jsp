...
.search__input:hover, .search__input:focus {
  ...
  <body>
   ...
   <c:if test="${startPage > 10}">
      <a href="/eatoday/homepage/recipeList.eat?pageNum=${startPage-10}">[이전]</a>
   </c:if>
   
   <c:forEach begin="${startPage}" end="${endPage}" step="1" var="i">
      <a href="/eatoday/homepage/recipeList.eat?pageNum=${i}">[${i}]</a>
   </c:forEach>
   
   <c:if test="${endPage < pageCount}">   
      <a href="/eatoday/homepage/recipeList.eat?pageNum=${startPage+10}">[다음]</a>
   </c:if>
</c:if>
